...
1. **Open-Source Convergence**: High-performing open-weight models (e.g., Llama, DeepSeek, Mistral) rapidly close the capability gap with proprietary models within months of release. This places a constant, aggressive ceiling on pricing power.
2. **Deflationary Token Pricing**: Architectural optimizations, hardware efficiency, quantization, and model distillation continue to reduce inference costs exponentially. As intelligence becomes cheap and easy to tap, price-per-token trends relentlessly toward marginal cost.
3. **Fungibility of General Intelligence**: For most practical enterprise and consumer tasks, a model that performs slightly better on benchmark tests does not command a proportional price premium. Intelligence rapidly becomes an interchangeable input.
